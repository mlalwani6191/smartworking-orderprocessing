...
use Smartworking\CustomOrderProcessing\Model\Api\RateLimiter;
...
class OrderProcessing implements OrderProcessingInterface
{
    ...
    private function rateLimiter(){
        ...
        try {
            $this->rateLimiter->limitRequestsInMinutes($limit, $minutes);
        } catch (\Exception $e) {
            return "Limit Reached please try after ". $seconds.' seconds';
        }
    }
